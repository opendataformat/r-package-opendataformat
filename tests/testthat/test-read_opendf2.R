#' read_opendf2: all languages
test_that("read_opendf2_all", {
  df <- read_opendf2(
...
#' read_opendf2: with default language
test_that("read_opendf2_variables", {
  df <- read_opendf2(
...
#' read_opendf2: "de" languages
test_that("read_opendf2_de", {
  df <- read_opendf2(
    file = "testdata/data.zip",
    languages = "de"
  )
...
# testthat::test_file("tests/testthat/test-read_opendf2.R")
# covr::package_coverage()

#' read_opendf2: nrows=10
test_that("read_opendf2_specific_rows", {
  df <- read_opendf2(
    file = "testdata/data.zip",
    nrows=10
  )
...
#' read_opendf2: nrows=13, skip=3
test_that("read_opendf2_specific_rows2", {
  df <- read_opendf2(
    file = "testdata/data.zip",
    nrows=13, 
    skip=3
...
#' read_opendf2: variables=c(1,2,4,5)
test_that("read_opendf2_specific_variables", {
  df <- read_opendf2(
    file = "testdata/data.zip",
    variables=c(1,2,4,5)
  )
...
#' read_opendf2: variables=c("bap87","bap96","bap9002","bap9003")
test_that("read_opendf2_specific_variables", {
  df <- read_opendf2(
    file = "testdata/data.zip",
...
#' read_opendf2: rows and cols
test_that("read_opendf2_specific_rows_and_cols", {
  df <- read_opendf2(
    file = "testdata/data.zip",
    nrows=13, 
    skip=3,
  ...
  expect_equal(attributes(df$bap9201)$label, "hours of sleep, normal workday")
  expect_equal(attributes(df$bap9201)$label_de, "Stunden Schlaf, normaler Werktag")
  expect_equal(attributes(df$bap9201)$label_en, "hours of sleep, normal workday")
...
#' read_opendf2: rows and cols2
test_that("read_opendf2_specific_rows_and_cols2", {
  df <- read_opendf2(
    file = "testdata/data.zip",
    nrows=13, 
    skip=3,
...
#' read_opendf2: language rows and cols
test_that("read_opendf2_specific_language_rows_and_cols", {
  df <- read_opendf2(
    file = "testdata/data.zip",
    nrows=13, 
    skip=3,
  ...
  # - variables content
  expect_equal(attributes(df$bap9201)$name, "bap9201")
  expect_equal(attributes(df$bap9201)$label, "Stunden Schlaf, normaler Werktag")
  expect_equal(attributes(df$bap9201)$label_de, "Stunden Schlaf, normaler Werktag")
  expect_equal(attributes(df$bap9201)$label_en, NULL)
  expect_equal(attributes(df$bap9201)$description_NA, NULL)
  expect_equal(attributes(df$bap9201)$description_de, "Schlafstunden pro Wochentag")
