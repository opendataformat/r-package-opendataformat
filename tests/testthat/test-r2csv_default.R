...
test_that("get_dataset_default", {
  # -- get data
  df <- get(load("testdata/data_odf_default_without_tag.RData"))
  # --- test column 'dataset'
...
test_that("var_df_default_label", {
  ...
  # -- test
  expect_equal(sort(colnames(var_df_default(df_no_label))),
               sort(c("variable",
                 "description",
                 "type",
                 "url" ))
...
test_that("var_header_var_var_default", {
  ...
  df <- get(load("testdata/data_odf_default_without_tag.RData"))
  # --- test
  expect_equal(sort(var_header_var_default(df$bap87)),
               sort(c("variable",
                 "label",
                 "description",
                 "type",
