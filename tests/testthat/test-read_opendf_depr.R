#' read_opendf_depr: all languages
test_that("read_opendf_depr_all", {
  df <- read_opendf_depr(
...
#' read_opendf_depr: default languages
test_that("read_opendf_depr_default", {
  df <- read_opendf_depr(
...
#' read_opendf_depr: "de" languages
test_that("read_opendf_depr_de", {
  df <- read_opendf_depr(
    file = "testdata/data.zip",
    languages = "de"
  )
...
# testthat::test_file("tests/testthat/test-read_opendf_depr.R")
