...
download.file("https://zenodo.org/records/12820591/files/opendataformat_1.1.0.tar.gz?download=1", 
              destfile = paste0(tempdir(), "/", "opendataformat_1.1.0.tar.gz"), method = "curl")
install.packages(paste0(tempdir(), "/", "opendataformat_1.1.0.tar.gz"), 
