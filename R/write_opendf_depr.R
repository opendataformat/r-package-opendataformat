...
#'
#' @description Export data from an R data frame to a ZIP file that stores the data
#' as Open Data Format. This function is depreciated, please use write_opendf().
#'
#' @import reticulate
#'
